                ...
                onPressed: () async {
                  naviagtionProvider.saveAndGoto(
                    ChangeNotifierProvider<CourtProvider>(
                      create: (BuildContext context) => CourtProvider(
                        searchField: searchController.text,
                        startDate: beginDateController.text,
                        endDate: endDateController.text,
                        decisionSubject: decisionController.text,
                        decisionNumber: roomController.text,
                      ),
                      child: const CourtResultScreen(),
                    ),
                  );
                },
                child: Row(
